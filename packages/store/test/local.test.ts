...
function record(id: string, endedAtMs: number): GameRecord {
  return {
    ...
    mode: 'ffa',
    seats: [
      { army: 'red', profileId: 'guest-1', bot: null, status: 'active' },
      { army: 'blue', profileId: null, bot: 'aggressive', status: 'checkmated' },
      { army: 'yellow', profileId: null, bot: 'opportunist', status: 'active' },
      { army: 'green', profileId: null, bot: 'turtle', status: 'resigned' },
    ],
